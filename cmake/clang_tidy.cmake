...
if(NOT (PROJECT_IS_TOP_LEVEL AND CLANG_TIDY_TOOL))
    return()
endif()
...
add_custom_target(
    clang-tidy
    COMMAND
        ${CMAKE_COMMAND} -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
        -DCMAKE_C_CLANG_TIDY="${CLANG_TIDY_TOOL}"
        -DCMAKE_CXX_CLANG_TIDY="${CLANG_TIDY_TOOL}" -S${PROJECT_SOURCE_DIR}
        -B${PROJECT_BINARY_DIR}
    COMMAND ${CMAKE_COMMAND} --build ${PROJECT_BINARY_DIR} -j
    COMMAND
        ${CMAKE_COMMAND} -DCMAKE_EXPORT_COMPILE_COMMANDS=OFF
        -DCMAKE_C_CLANG_TIDY="" -DCMAKE_CXX_CLANG_TIDY=""
