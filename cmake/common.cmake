...
function(RUN_CMD)
    ...
    if(NOT "${_dir}" STREQUAL "")
        ...
        execute_process(COMMAND ${_cmd} RESULT_VARIABLE err_result COMMAND_ECHO
                                                        STDOUT)
    endif()
    if(err_result)
...
macro(FIND_OR_BUILD)
    ...
    # if(${CMAKE_VERSION} VERSION_LESS "3.16") set(empty_submodule "src") else()
    # cmake_policy(SET CMP0097 NEW) set(empty_submodule "") endif()
    FetchContent_Declare(
        ${_target}
        GIT_REPOSITORY ${_git_url}
        GIT_TAG ${_git_tags}
