...
add_custom_target(
    check-memory
    COMMAND ${CMAKE_COMMAND} -B ${CMAKE_BINARY_DIR} -DENABLE_MEMORY_CHECKER=ON -S ${CMAKE_SOURCE_DIR}
    ...
    # COMMAND ${CMAKE_CTEST_COMMAND} -VV --test-dir ${CMAKE_BINARY_DIR} -j # 3.29
    COMMAND ${CMAKE_COMMAND} -B ${CMAKE_BINARY_DIR} -DENABLE_MEMORY_CHECKER=OFF -S ${CMAKE_SOURCE_DIR}
